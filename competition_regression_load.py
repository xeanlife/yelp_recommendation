...
## Execution Time:
# 1058s
# The execution time seems to be dramatically longer now as the deadline approaches,
# so I have swapped to loading the model in with pickle instead.
## --------------------------------------------- ##
...
test_file_name = 'yelp_test_in.csv'
...
## Fit XGBRegressor
xgb_tree_best = pickle.load(open('xgb_tree_best_05_02.pkl', 'rb'))


## Fit Catboost
cat_reg = pickle.load(open('cat_reg_05_02.pkl', 'rb'))
